 ...
 * @version    SVN: $Id$
 */
class dakWidgetFormJQueryDate extends sfWidgetForm
{
  /**
   ...
   *  * onSelect:    What should happen when the user clicks a date?
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('onSelect', 'wfd_%s_update_linked'); // can be function (date) { wfd_%s_update_linked(), someotherfunction
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    $onSelect = sprintf($this->getOption('onSelect'), $prefix);
...
EOF
      ...
      $id,
      min($years), max($years),
      $prefix, $onSelect, $image, $this->getOption('culture'), $this->getOption('config'),
      $prefix,
