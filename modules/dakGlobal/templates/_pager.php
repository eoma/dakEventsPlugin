<?php // Demands the objects pager and route ?>
  ...
  <div class="pagination">
    <a href="<?php echo url_for($route) ?>?page=1">
      <img src="<?php echo public_path('/images/first.png') ?>" alt="First page" title="First page" />
    </a>
 
    <a href="<?php echo url_for($route) ?>?page=<?php echo $pager->getPreviousPage() ?>">
      <img src="<?php echo public_path('/images/previous.png') ?>" alt="Previous page" title="Previous page" />
    </a>
    ...
    <a href="<?php echo url_for($route) ?>?page=<?php echo $pager->getNextPage() ?>">
      <img src="<?php echo public_path('/images/next.png') ?>" alt="Next page" title="Next page" />
    </a>
 
    <a href="<?php echo url_for($route) ?>?page=<?php echo $pager->getLastPage() ?>">
      <img src="<?php echo public_path('/images/last.png') ?>" alt="Last page" title="Last page" />
    </a>
  </div>
